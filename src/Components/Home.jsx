      ...
      <div className="row container justify-content-end">
        <div className="col-md-5 ml-4">
          ...
          <div className="row">
            ...
            <button
              onClick={() =>
                window.open(
                  "https://drive.google.com/file/d/1IfBUlN6SxM6ETi6NDzJfpkGMzhRVYi3V/view?usp=share_link"
                )
              }
        ...
        <div className="col-md-5">
          <div className="display_div ml-auto">
            <img src="/WhatsApp Image 2023-08-17 at 13.24.35.jpeg" style={{objectFit:"contain", background:"rgb(25 25 27)"}} className="display_img" />
          </div>
        </div>
      </div>
      <div
